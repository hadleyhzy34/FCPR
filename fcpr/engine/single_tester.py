...
from fcpr.engine.base_tester import BaseTester
from fcpr.utils.summary_board import SummaryBoard
from fcpr.utils.timer import Timer
from fcpr.utils.common import get_log_string
from fcpr.utils.torch import release_cuda, to_cuda
...
class SingleTester(BaseTester):
    ...
    def run(self):
        ...
        for iteration, data_dict in pbar:
            ...
            output_dict, msg = self.test_step(self.iteration, data_dict)
