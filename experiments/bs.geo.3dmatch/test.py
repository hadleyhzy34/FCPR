...
import numpy as np
import pdb
from fcpr.engine import SingleTester
# from geotransformer.engine import SingleTester
from fcpr.utils.torch import release_cuda
from fcpr.utils.common import ensure_dir, get_log_string

from dataset import test_data_loader
from config import make_cfg
from model import create_model

from net_floodfill import create_search
...
class Tester(SingleTester):
    def __init__(self, cfg):
        ...
        self.bs = create_search(cfg).cuda()
    ...
    def test_step(self, iteration, data_dict):
        ...
        # output_dict = self.bs(output_dict)
        output_dict, msg = self.bs(output_dict)
        # pdb.set_trace()
